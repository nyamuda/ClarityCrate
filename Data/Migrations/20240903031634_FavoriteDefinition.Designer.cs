...
namespace Clarity_Crate.Migrations
{
    ...
    [Migration("20240903031634_FavoriteDefinition")]
    partial class FavoriteDefinition
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LevelTerm", b =>
                {
                    ...
                    b.HasKey("LevelsId", "TermsId");

                    b.HasIndex("TermsId");

                    b.ToTable("TermLevel", (string)null);
                });
            ...
            modelBuilder.Entity("Clarity_Crate.Models.Definition", b =>
                {
                    ...
                    b.HasOne("Clarity_Crate.Models.Term", "Term")
                        .WithOne("Definition")
                        .HasForeignKey("Clarity_Crate.Models.Definition", "TermId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LevelTerm", b =>
                {
                    ...
                    b.HasOne("Clarity_Crate.Models.Term", null)
                        .WithMany()
